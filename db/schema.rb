...
ActiveRecord::Schema.define(version: 20150602220250) do
  ...
  add_index "blurbs", ["datasource_id"], name: "index_blurbs_on_datasource_id"
  add_index "blurbs", ["project_id"], name: "index_blurbs_on_project_id"
