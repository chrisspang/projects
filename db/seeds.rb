...
#
# Create ourselves our base Nestoria datasource and builder
#
Datasource.create({
                     name: 'nestoria',
                     title: 'Nestoria'
...
# Now create random guff for development testing
case Rails.env
when "development"
  Datasource.create([
                     {
...
puts ""
puts "We have #{Image.count} Images"
puts "We have #{Blurb.count} Blurbs"
puts "We have #{Datasource.count} Datasources"
puts "We have #{Builder.count} Builders"
puts "We have #{Project.count} Projects"
